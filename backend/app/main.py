...
def _draft_haro_replies(db: Session, digest_text: str) -> list[dict]:
    ...
    system_prompt = (
        ...
        "query on <topic> for <outlet>. Here are a few things from Tulo that might help answer your "
        "questions below:'. When there's a real throughline across the sub-questions beyond just the "
